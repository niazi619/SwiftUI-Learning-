...
class ThursdayUIDesignViewModel2: ObservableObject {
    ...
    @Published var forYouDataList: [ThursdayUIDesignDataModel2] = [
    ...
    @Published var freeTodayDataList: [ThursdayUIDesignDataModel2] = [
        ...
        ThursdayUIDesignDataModel2(name: "Beauty", image:"circle.dotted.circle", lock: false),
        ThursdayUIDesignDataModel2(name: "Loving kindness", image:"leaf", lock: false),
    ...
    @Published var mostPopularDataList: [ThursdayUIDesignDataModel2] = [
